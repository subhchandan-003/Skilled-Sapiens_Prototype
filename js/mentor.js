        ...
        return `
            <div class="followup-card">
                <div class="student-info">
                    ${createInitialsAvatarHTML(user?.name || 'S', 50)}
                    <div>
                        <h4>${user?.name}</h4>
                        <p>${user?.email}</p>
                    </div>
        ...
        return `
            <div class="review-card">
                <div class="submission-info">
                    ${createInitialsAvatarHTML(user?.name || 'S', 40)}
                    <div>
                        <h4>${user?.name}</h4>
                        <p>${task?.title}</p>
        ...
        <div class="modal" id="studentModal" style="display: flex;">
            <div class="modal-content student-modal-content">
                ...
                <div class="student-profile">
                    ${createInitialsAvatarHTML(student.name, 80)}
                    <h2 style="margin-top:12px">${student.name}</h2>
                    <p>${student.email}</p>
